...
if __name__ == '__main__':
    ...
    parser.add_argument('--valid_path', type=str, default='/workspace/datasets/Structured3D_SRC/val') # file path which contains images to validated
    ...
    ####### Data directory ###### 
    parser.add_argument('--S3D_path',help='Folder containing Structure3D dataset', type=str,default='/workspace/datasets/Structured3D_SRC/train') # Structure3D dataset path
    ...
    ##### Starting options #####
    parser.add_argument('--Continue', help=' Strat training from the checkpoint', default=True,action='store_true')
    ...
    parser.add_argument('--checkpoint_path', type=str, help='path of pretrained weight')
